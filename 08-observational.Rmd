...
## Does maternal obesity increase the risk of colorectal cancer?
...
from 1.]  The authors are careful to acknowledge that, as an
observational study, it could not establish cause, and that
factors such as diet and microbiome might explain the
association.  Nonetheless, they argue that "in utero events 
are important risk factors for CRC and may contribute to 
increasing incidence rates in younger adults."

Although a large study (18,751 live births), the total 
number of offspring diagnosed with colorectal cancer was 68.
