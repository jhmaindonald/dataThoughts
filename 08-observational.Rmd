...
[Andrew Gelman's blog](https://statmodeling.stat.columbia.edu/2018/11/10/matching-discarding-non-matches-deal-lack-complete-overlap-regression-adjust-imbalance-treatment-control-groups/)^[https://statmodeling.stat.columbia.edu/2018/11/10/matching-discarding-non-matches-deal-lack-complete-overlap-regression-adjust-imbalance-treatment-control-groups/] canvasses some of the more important issues. There are no simple
...
> `timePerKm` = `r round(constSl,2)` + `r round(bsl[2],2)` $\times$ `log(Dist)`   
...
were banned.  @hassall1850memoir, in a careful microbiological study, commented that:
