...
FORCEE project [@wegwarth2018european]:
...
similar as possible to the treatment.^[For a helpful animated summary of some of the key issues, see: <https://www.youtube.com/watch?v=Wy7qpJeozec>]
...
the same direction.^[Note the comments on Lord's paradox
...
and 34 (2%) in the aspirin group^[<https://www.theguardian.com/society/2009/aug/31/aspirin-british-heart-foundation>]  It is important that all adverse effects are documented.

For a summary of current evidence, see @barbarawi2019aspirin.
