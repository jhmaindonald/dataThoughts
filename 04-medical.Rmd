...
A focus on medicine and public health is used as a context in
which to introduce ideas and issues that are more generally
relevant.  There is wide acceptance that the evidence provided 
by randomized controlled trials (RCTs) that are conducted to 
high standards is at the top of a hierarchy of evidence.

Web sources are noted that, because they base their advice on 
careful and transparent evaluations of the available evidence,
can be trusted.
...
that the authors could identify.  There may be many published 
studies, not all of equal quality, that bear on a medical issue.
Or there may be one, or a small number, of large-scale high 
quality trials that are used as a basis for judgment.  It is
important that assessments are updated as new evidence emerges.
...
There is extensive informative content on the [Harding Center for Risk Literacy site.](https://www.hardingcenter.de/en)^[<https://www.hardingcenter.de/en>]  Note in particular
...
See @martin2018effect, @levitin_2015 [chap. 6], @fung2020cancer [pp. 278-281],
and the web page [How Patients Think, and How They Should](https://www.nytimes.com/2011/10/09/books/review/your-medical-mind-by-jerome-groopman-and-pamela-hartzband-book-review.html)^[<https://www.nytimes.com/2011/10/09/books/review/your-medical-mind-by-jerome-groopman-and-pamela-hartzband-book-review.html>]
...
based on randomized controlled trials over 3 decades in Western countries 
has not only eclipsed the paradigm of evidence-based medicine, but also puts health decision-makers in countries where breast cancer screening is still being considered in a dilemma to adopt or abandon such a well-established screening modality.
...
The chief English source of evidence for the fact box is the 
Cochrane review @gotzsche2013screening.  Eligible trials included 
more than 600,000 women.

@loberg2015benefits provide a slightly more detailed breakdown 
of the evidence, as applied to women who were screened 
for 20 years, starting at age 50, with mortality assessed 
at ages 56 to 75 in the UK. .  Figure \@ref(fig:c-screen) 
is a visual summary.
Interval cancers are cancers that are detected in between regular 
screens.  A prior normal screen may give a false assurance and 
lead to a delay in seeking help when symptoms appear.
...
@fung2020cancer gives a readable summary of 
the evidence, for a number of different cancers. In the case
of breast cancer, the widespread introduction of screening
has dramatically increased the detection of early stage cancers, 
a large proportion of which will never progress to become 
symptomatic or life-threatening.  Over-diagnosis leads to invasive
tests and treatments that themselves carry, over the medium to
long term, serious physical and mental risks.

It may be argued that there have been improvements in medical 
procedures since the trials on which the Fact Boxes are based 
that have changed the balance of risk, or that the trials do 
not apply to New Zealand conditions.  Both cases require 
justification. It is not legitimate to focus on "cancers"
detected, without regard to sources of harm.

The FORCEE project [@wegwarth2018european], currently in progress
at the Harding Center study, has as an aim the individualising 
...
is presented in @soni2019comparison (studies in oncology) 
contrasts with the more positive view offered in
@anglemyer2014healthcare (health care), for observational 
...
hierarchy of evidence that is set down in the [@us1989guide] 
guide:
...
studies, the STROBE guidelines [@erik2007strengthening] set out
reporting standards.
...
obesity-related diseases" [@hu2013resolved] provides an
...
evidence from published review sources, @chalmers2009avoidable 
...
before the study 
begins.^[See <https://plos.org/open-science/preregistration/>]
...
who do not.^[These are known as the "sensitivity", and the
"specificity".]  
...
Later work indicated that benefits are limited to those with 
previous symptoms. A 2009 study found that major bleeding episodes, 
requiring admission to hospital, were 20 (1.2%) in the placebo group,
and 34 (2%) in the aspirin group^[<https://www.theguardian.com/society/2009/aug/31/aspirin-british-heart-foundation>].  @barbarawi2019aspirin gives a summary of current evidence.
