...
```{r plotchanges, echo=FALSE, eval=TRUE, fig.width=6, fig.height=3.75, out.width="90%", fig.cap=cap2, fig.align='center'}
...
xyplot(nm+nf~year|name, data=lookat,  xlab="Year", 
       ylab="Number of babies", par.settings=simpleTheme(pch=c(3,2)), 
...
damage caused at the time to 2014 US\$.^[The damage measure that
