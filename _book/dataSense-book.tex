...
Cokely et al. (\citeproc{ref-cokely2012measuring}{2012}).
...
\item
  ...
  \item
    ...
    (\citeproc{ref-levitin_2015}{Levitin 2015, 245})
  \item
...
Pashayan et al. (\citeproc{ref-pashayan2020personalized}{2020}) provide an overview of progress towards
...
Young (\citeproc{ref-young2014improving}{2014}) gives an account of A/B testing as it might be used
...
in Soni et al. (\citeproc{ref-soni2019comparison}{2019}) (studies in oncology) contrasts with the more
positive view offered in Anglemyer, Horvath, and Bero (\citeproc{ref-anglemyer2014healthcare}{2014}) (health care), for
...
evidence that is set down in the (\citeproc{ref-us1989guide}{US Preventive Services Task Force 1989}) guide:
...
The CONSORT 2010 statement (\citeproc{ref-Schulzc332}{Schulz, Altman, and Moher 2010}) sets out detailed criteria for
assessing randomized controlled trials (RCTs). For Level II studies, the
STROBE guidelines (\citeproc{ref-erik2007strengthening}{Erik von Elm et al. 2007}) set out reporting standards.
...
prevalence of obesity and obesity-related diseases'' (\citeproc{ref-hu2013resolved}{Hu 2013})
...
published review sources, Chalmers and Glasziou (\citeproc{ref-chalmers2009avoidable}{2009}) found issues with the
...
Du Toit et al. (\citeproc{ref-du2015randomized}{2015}).
...
serious harm.\footnote{For the history, see for example
  Seigworth (\citeproc{ref-seigworth1980bloodletting}{1980})} The practice attracted widespread debate
...
See Martin et al. (\citeproc{ref-martin2018effect}{2018}), Levitin (\citeproc{ref-levitin_2015}{2015}, ch.~6), Fung (\citeproc{ref-fung2020cancer}{2020, 278--81}), the web page \href{https://www.nytimes.com/2011/10/09/books/review/your-medical-mind-by-jerome-groopman-and-pamela-hartzband-book-review.html}{How Patients Think, and How They
...
review Gøtzsche and Jørgensen (\citeproc{ref-gotzsche2013screening}{2013}). The eight eligible trials included more
...
Løberg et al. (\citeproc{ref-loberg2015benefits}{2015}) provide a slightly more detailed breakdown of the
...
earlier or later. Moran and Cullinan (\citeproc{ref-MORAN2022115073}{2022}) looked at data on the ten-year
...
As argued in Esserman and WISDOM Study and Athena Investigators (\citeproc{ref-essermanwisdom}{2017}), women want ``better, not more screening''.
...
\item
  Cairo (\citeproc{ref-cairo_2013}{2013}) . The functional art: an introduction to information
  graphics and visualization.
\item
  Ritchie (\citeproc{ref-ritchie2020science}{2020}) . Science fictions: Exposing fraud, bias,
