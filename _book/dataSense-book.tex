...
\hypertarget{do-you-understand-risk}{%
\subsection*{Do you understand risk}\label{do-you-understand-risk}}
\addcontentsline{toc}{subsection}{Do you understand risk}

See the 2-minute test
\{``Do you understand risk?''{]}(\url{http://www.riskliteracy.org/})\footnote{\url{http://www.riskliteracy.org/}}
...
{\centering \includegraphics[width=0.48\linewidth]{02-graphs_files/figure-latex/lnscales-1} 
...
Medical fact boxes\textsuperscript{{[}\url{https://www.hardingcenter.de/en/transfer-and-impact/fact-boxes}{]}}{[}\url{https://www.hardingcenter.de/en/transfer-and-impact/fact-boxes}{]} provide visual and tabular summaries of the current
...
\tightlist
\item
  \href{https://www.hardingcenter.de/sites/default/files/2020-01/harding_schnelltest_us_1809067_1215.pdf}{Are you risk literate? --- Risk quiz}\footnote{\url{https://www.hardingcenter.de/sites/default/files/2020-01/harding_schnelltest_us_1809067_1215.pdf}}

  \begin{itemize}
  \tightlist
  \item
    On the development of the quiz, see \protect\hyperlink{ref-cokely2012measuring}{Cokely et al.} (\protect\hyperlink{ref-cokely2012measuring}{2012})
  \end{itemize}
\end{itemize}
...
\section{PSA Screening for Prostate Cancer, \& more}\label{psa-screening-for-prostate-cancer-more}}
...
ten countries, but (as the next graph will show) huge country
