...
it is a relative amount scale that is appropriate.\footnote{Technically,
  such scales are known as logarithmic,~as opposed to straight
  line or linear, scales. For this purpose, all one needs to know
  about taking logarithms is that it gives such relative distance
  scales.}
...
relative \texttt{Distance} scale in Figure \ref{fig:resid}\} in
Subsection \ref{track}.
...
As of August 15, Israeli data showed that 214 of those hospitalized
with severe Covid-19 were fully vaccinated, while 301 were not. The
explanation is simple: older~people are both more likely to be
vaccinated and more likely to have severe responses. Taking
account first of the much higher numbers vaccinated than
unvaccinated, percentages of severe cases are:
...
---- & ---- & ---- & \\
Number \textgreater50 & 186,078 & 2,133,518 & \\
Severe cases & 171 (91.9\%) & 290 (13.6\%) & \\
\bottomrule
\end{longtable}

The numbers of severe cases are much higher
for the over 50s than for the under 50s ---
a ratio of 5.0 (=214/430 for the unvaccinated, and 27.4 (=301/11)
for the fully vaccinated. The effect is to weight the
all ages percentages of severe cases towards the number
for the over 50s.

Misleadingly, the all ages percentage goes down from 91.9\% to
an overall 16.4\% for the unvaccinated, and down from 13.6\% to
an overall 5.3\% for the fully vaccinated. This is an example
of the Yule-Simpson paradox at work.\footnote{See \url{https://bit.ly/3h1mwXQ} for further commentary.}

\hypertarget{university-admissions-data-berkeley}{%
\section{University admissions data (Berkeley)}\label{university-admissions-data-berkeley}}
...
The absolute difference from the mean moves from 8 to 0.7\(\times 8 (= 5.6) to 0.7\)\times 5.6 (= 3.92), whether one moves
...
Figure \ref{fig:resid}B gives a visual representation of the
...
\begin{theindex}
  ...
  \item algorithmic methods (\textit{see also} machine learning), 
        63, 64
  ...
  \item graph
    ...
    \subitem debt vs debt to GDP ratio, 34--36
    \subitem decathlon performances in 2006, 52
    \subitem email spam, distribution of values, 63
    \subitem father vs son heights, 48, 49
    \subitem global temperature trends, 68, 79
    \subitem John Snow's 1854 cholera map, 61
    \subitem London 1849 cholera deaths, 58
    \subitem naming trends over time, 83, 84
    \subitem NBA player points, 50
    \subitem relative change (logarithmic) scale, 11--13, 58, 65, 66
    \subitem replicate vs original effect size, 77
    \subitem Secrist and regression to mean, 50, 51
    \subitem time vs distance, 12, 52, 56, 57
    \subitem UCB admissions data, 41
  ...
  \item machine learning
    \subitem detection of Covid-19 from chest images, 74, 75
  \item malaria drugs
    \subitem use with Covid-19, 37, 72
  \item maternity care
  ...
  \item NBA player points, correlation declines over time, 50
  ...
  \item regression predictions
    \subitem drivers, 55--57
  \item regression to the mean, 18, 43, 50, 51, 54, 57, 58
    \subitem fathers and sons, 48, 49
    \subitem NBA player total points, 50
    \subitem Secrist's 'Triumph of Mediocrity', 52
  \item replication, 6, 74, 77, 78
  \item risk assessment
    \subitem sources of advice, 4, 7, 20, 23, 24, 27, 29, 30, 37, 75, 
        81
  ...
  \item science
    ...
    \subitem false or unverified claims, 6, 21, 23, 75, 78
    \subitem funding and reward processes, 72, 78, 80, 82
    \subitem results that special interests find inconvenient, 79, 80
  \item Secrist and regression to mean, 50, 51
