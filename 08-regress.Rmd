...
```{r pearson, fig.asp=0.85, fig.width=4.5,out.width="48%", fig.show="hold", fig.cap=cap12}
...
```{r Decath2006, fig.width=10, fig.asp=0.9, out.width="75%", fig.pos='H', results="hide", fig.cap=cap13}
...
```{r select, fig.width=5, fig.asp=0.85, results='hide', warning=FALSE, message=FALSE, fig.pos='H', out.width="80%"}
choosecols <- ord[5:9]
...
```{r expend, warning=FALSE, fig.asp=0.95, out.width="80%", fig.pos='H',  fig.cap=cap14}
...
```{r NBA, out.width="49%", fig.width=4.0, fig.asp=1, fig.show="hold", fig.pos="H", fig.cap=cap12.5}
...
```{r sim, out.width="105%", fig.width=7.5, fig.asp=0.45, fig.cap=cap15, fig.pos='H'}
