...
```{r riskByAge, out.width='50%', echo=FALSE, fig.cap="Proportions who died, from Covid-19, and in total"}
...
ylab <- sort(outer(10^seq(from=-4, to =2,by=1),c(1,3.2)))
...
```{r admitrates, comment=NA, results='asis'}
...
```{r totals, comment=NA, results='asis'}
library(xtable)
