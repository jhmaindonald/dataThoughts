...
An understanding of the mental traps to which we are prone can help us avoid them. Kahneman's book [-@kahneman_2013] *Thinking Fast and Slow* is a good starting point for thinking about the strengths and limitations of human thinking processes.  There is no good substitute
...
-   In its world, gorillas do not cross basket-ball courts ...[^01-judgment-1]
...
[^01-judgment-1]: See http://theinvisiblegorilla.com/gorilla_experiment.html
...
> ... An expert is one who has built a deep familiarity with the patterns of a given domain and, thus, has a robust body of work from which to reference when making decisions.[^01-judgment-2]

[^01-judgment-2]:  <http://www.euclidean.com/expert-intuition-and-machine-learning/>
...
> [Prostate biopsy specialist, in response to evidence that screening may be counterproductive, quoted in @levitin_2015, p.247]

The following comment appeared in a discussion of the response to a U.S. Preventive Services assessment that prostate screening, when used in accordance with then current treatment practices, was doing more harm than good.[^01-judgment-3]
...
### A simple (and, arguably, trick) example {.unnumbered}
...
See the 2-minute test ["Do you understand risk?"](http://www.riskliteracy.org/)[^01-judgment-4]
