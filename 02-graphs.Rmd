...
```{r cap6, echo=FALSE}
cap6 <- "Panel A plots world record Time (as of 2006, in minutes)
...
relative `Distance` scale in Figure \@ref(fig:resid)} in
...
* Good & bad graphs (Ihaka, lecture notes)^[https://www.stat.auckland.ac.nz/~ihaka/120/Lectures/lecture03.pdf]
